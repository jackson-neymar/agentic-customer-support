...
def create_entry_node(assistant_name: str, new_dialog_state: str) -> Callable:
    def entry_node(state: State) -> dict:
        ...
        tool_messages = []
        print(f"--- ENTERING ENTRY NODE: {assistant_name} ---") # 添加调试打印
...
def download_and_prepare_db():
    ...
    if not os.path.exists(db_dir):
        os.makedirs(db_dir)
    db_url = "/home/xjs/big_space/code/LLM_study/multi-agent-rag-customer-support-main/customer_support_chat/data/travel2.sqlite"
